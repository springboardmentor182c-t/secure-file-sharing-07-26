    ...
    <Card delay={0.35}>
      ...
      {loading ? (
        <div className="an-system-sections">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="an-system-section">
              <Skeleton style={{ width: "30%", height: 11, marginBottom: 8 }} />
              <div className="an-system-grid">
                {[1, 2].map((j) => (
                  <Skeleton key={j} style={{ height: 56, borderRadius: 12 }} />
                ))}
              </div>
            </div>
          ))}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="an-system-stat-body">
                          <div className="an-system-stat-value">
                            {value}
