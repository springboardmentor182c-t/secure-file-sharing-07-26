...
# Anchor to the server package root so CWD doesn't decide where files land.
UPLOAD_DIR = Path(os.getenv("UPLOAD_DIR") or Path(__file__).resolve().parents[2] / "uploads")
