...
class DashboardProfile(Base):
    ...
    greeting: Mapped[str] = mapped_column(String(120), nullable=False)
...
class DashboardStat(Base):
    ...
    trend: Mapped[str] = mapped_column(String(80), nullable=False)
...
class DashboardStorageSummary(Base):
    ...
    plan_label: Mapped[str] = mapped_column(String(80), nullable=False)
    free_label: Mapped[str] = mapped_column(String(80), nullable=False)
...
class DashboardChart(Base):
    ...
    secondary_value: Mapped[int | None] = mapped_column(Integer, nullable=True)
    display_order: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
