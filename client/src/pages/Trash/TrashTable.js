  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center py-16">
        <p className="text-gray-400 text-lg">Loading trash files...</p>
      </div>
    );
  }
  ...
  if (!files.length) {
    return (
      <div className="flex flex-col items-center justify-center py-20 bg-slate-900 rounded-xl border border-slate-800">
        ...
        <p className="text-gray-400 mt-2">Deleted files will appear here.</p>
      </div>
    );
  }
      ...
      <table className="min-w-full">
        <thead className="bg-slate-800">
          <tr>
            ...
            <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">Updated At</th>
